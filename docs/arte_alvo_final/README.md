...
| 15 | `15_turnaround_fase3.png` | Turnaround 4 vistas do GLB da Fase 3 completa — `assets/characters/source/heroi_julia/heroi_julia_pbr.glb` (1.798 KB): olhos, sobrancelha, cílios e cabelo (rabo de cavalo em 5 mechas + franja) sobre o corpo PBR da Fase 2. Ver `docs/execucao/HEROI_FASE3.md`. |
| 16 | `16_rosto_fase3_olhos_cabelo.png` | Close do rosto no GLB da Fase 3 (`render_detalhe.py --alvo rosto --samples 48`): globo ocular (esclera+córnea+íris com normal radial), sobrancelha e cílio em cartões finos, franja sobre a testa. Gate 3 (rosto legível a 2 m). |
