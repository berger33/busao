...
- **Materiais PBR consistentes**: asfalto com brita e rachaduras, calçada portuguesa no padrão Copacabana, fachadas de reboco e tijolo com janelas/peitoril/AO em textura, céus equiretangulares 2K com nuvens e sol, tonemap ACES e pintura automotiva com flakes metálicos — tudo gerado por `tools/generate_textures.py` (albedo + normal + roughness, tileable e determinístico). Veículos procedurais podem ser substituídos por modelos GLB CC0 soltos em `assets/vehicles/` (ver `docs/PLAYSTORE_AUDIT.md`).
