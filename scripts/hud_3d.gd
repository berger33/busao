...
func _draw_menu() -> void:
    ...
    var gesture_sensitivity := float(GameSave.data.get("gesture_sensitivity", 1.0))
    _button(Rect2(420, 276, 52, 32), "GESTO −", Color("#263958"), 9)
    _button(Rect2(478, 276, 110, 32), "GESTO %.2fx" % gesture_sensitivity, Color("#263958"), 9)
    _button(Rect2(594, 276, 72, 32), "GESTO +", Color("#263958"), 9)
