...
func _scenario_x() -> void:
    ...
    _start_phase(0)
    var fase1_e: bool = _deck_cobre(-3.25)
    var fase1_c: bool = _deck_cobre(0.0)
    print("deck fase1: E=%s C=%s (leiaute padrão)" % [str(fase1_e), str(fase1_c)])
    _check(not fase1_e and fase1_c,
